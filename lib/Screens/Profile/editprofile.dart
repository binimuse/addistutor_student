...
class _EditPageState extends State<EditPage> {
  ...
  void _fetchUser() async {
    ...
    if (token != null) {
      ...
      pfcontroller.fetchPf(body["id".toString()]);
    }
  }
          ...
          child: GestureDetector(
            ...
            child: ListView(
              children: [
                ...
                DropdownButton<String>(
                  value: editprofileController.locaion.value,
                  hint: const Text(
                    "Location",
                    style: TextStyle(
                        color: Colors.black,
                  ...
                  onChanged: (value) {
                    setState(() {
                      editprofileController.locaion.value = value!;
                    });
                  },
                ),
                const SizedBox(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      if (editprofileController.studyperpose.value ==
                          "Specific support") {
                        supportbool = true;
                      } else if (editprofileController.studyperpose.value ==
                          "Other") {
                        supportbool = true;
                      } else {
                        supportbool = false;
